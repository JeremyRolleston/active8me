...
define('DOMAIN_NAME', 'active8me.sourcefuse.com/');
define('FULL_DOMAIN_NAME', 'http://' . DOMAIN_NAME);
define('SITE_IMAGE_URL', FULL_DOMAIN_NAME.'img/');
define('BREAKFAST_TIME', '08:00:00');
define('LUNCH_TIME', '12:00:00');
define('WORKOUT_TIME', '13:00:00');
define('SNACK_TIME', '16:00:00');
define('DINNER_TIME', '20:00:00');
define('NUTRITION_POINTS', 50);
define('WORKOUT_POINTS', 100);
define('WEEKLY_POINTS', 1800);

Configure::write('CakeApns', array(
    'mode' => 'sandbox',
    'sandbox' => array(
        'combined_certificates' => APP . 'Certificates' . DS . 'activateme.pem',
        'cert_passphrase' => 'sourcefuse'
    ),
    'production' => array(
        'combined_certificates' => APP . 'Certificates' . DS . 'activateme.pem',
        'cert_passphrase' => 'sourcefuse'
